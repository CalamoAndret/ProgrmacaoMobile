...
`}</Text>
        ...
        <View style={[styles.categoriesInner, styles.categoriesPosition]}>
          <View style={styles.groupWrapper}>
            <View style={styles.recomendedParent}>
              ...
              <Pressable
                style={[styles.pizzaWrapper, styles.pizzaLayout]}
                onPress={() => navigation.navigate("CategoriaDoces")}
              >
                <View style={[styles.pizza, styles.pizzaLayout]}>
                  <View style={[styles.pizzaChild, styles.childBg]} />
                  <Text style={[styles.doces, styles.cidasTypo]}>Doces</Text>
                </View>
              </Pressable>
              <View style={[styles.sandwitch, styles.sandwitchLayout1]}>
                <View
                  style={[styles.sandwitchChild, styles.sandwitchLayout1]}
                />
      ...
      <View style={styles.foodBox}>
        <Pressable
          style={[styles.disBox11, styles.disShadowBox]}
        ...
        <View style={[styles.disBox21, styles.disShadowBox]}>
          ...
          >
            ...
            <Image
              style={[styles.apples15061196401Icon, styles.iconLayout]}
              contentFit="cover"
              source={require("../assets/berries2277-640-1@3x.png")}
            />
          </ImageBackground>
          <View style={[styles.nameGroup, styles.nameGroupPosition]}>
            <View style={[styles.name1, styles.namePosition]}>
              ...
              <Text style={[styles.ma, styles.maTypo]}>Amora</Text>
            </View>
        ...
        <View style={[styles.disBox31, styles.disShadowBox]}>
          ...
          >
            ...
            <Image
              style={[styles.apples15061196401Icon, styles.iconLayout]}
              contentFit="cover"
              source={require("../assets/pineapple1441384-640-1@3x.png")}
            />
          </ImageBackground>
          <View style={[styles.groupView, styles.name2Layout]}>
            <View style={[styles.name2, styles.name2Layout]}>
              ...
              <Text style={[styles.ma, styles.maTypo]}>Abacaxi</Text>
            </View>
            <View style={[styles.sub1, styles.subPosition]}>
              <Text style={[styles.km, styles.kmTypo]}>4.7 Km</Text>
              <View style={[styles.rating1, styles.ratingPosition]}>
        ...
        <View style={[styles.disBox41, styles.disShadowBox]}>
          ...
          >
            <View style={[styles.imgChild, styles.childLayout]} />
            <Image
              style={[styles.barbadosCherry70517526401Icon, styles.iconLayout]}
              contentFit="cover"
              source={require("../assets/barbadoscherry7051752-640-1@3x.png")}
            />
            <Image
              style={[styles.apples15061196401Icon, styles.iconLayout]}
              contentFit="cover"
              source={require("../assets/barbadoscherry7051752-640-2@3x.png")}
            />
          </ImageBackground>
          <View style={[styles.nameParent, styles.nameGroupPosition]}>
            <View style={[styles.name, styles.namePosition]}>
              ...
              <Text style={[styles.ma, styles.maTypo]}>Acerola</Text>
            </View>
            <View style={[styles.sub1, styles.subPosition]}>
              <Text style={[styles.km, styles.kmTypo]}>1.8 Km</Text>
              <View style={[styles.rating1, styles.ratingPosition]}>
        ...
        <View style={[styles.disBox61, styles.disShadowBox]}>
          ...
          >
            ...
            <Image
              style={[styles.apples15061196401Icon, styles.iconLayout]}
              contentFit="cover"
              source={require("../assets/oranges1995056-640-1@3x.png")}
            />
          </ImageBackground>
          <View style={[styles.nameParent, styles.nameGroupPosition]}>
            <View style={[styles.name5, styles.nameLayout]}>
              ...
              <Text style={[styles.ma, styles.maTypo]}>{`Laranja
`}</Text>
            </View>
            <View style={[styles.sub1, styles.subPosition]}>
      ...
      <View style={styles.navPosition}>
        ...
        <View style={styles.stats}>
          <Text style={[styles.text13, styles.text13Typo]}>9:41</Text>
          <Image
